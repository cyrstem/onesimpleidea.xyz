...
// import imageOne from '../../images/insta-0.jpg';
...
console.log(_data.default.projects[0]);
...
exports.default = _default;
},{"../../data.json":"data.json","../images.js":"js/images.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js","./interface/Nav":"js/interface/Nav.js","./interface/Contact":"js/interface/Contact.js","./pages/Home":"js/pages/Home.js","./pages/Portafolio":"js/pages/Portafolio.js","./pages/Experiments":"js/pages/Experiments.js"}],"../node_modules/ogl/src/math/functions/Vec3Func.js":[function(require,module,exports) {
"use strict";
...
class GLTFLoader {
  ...
  static parseMeshes(gl, desc, bufferViews, materials, skins) {
    ...
    return desc.meshes.map(({
      ...
      let isSkin = !!skinIndices.length; // For skins, return array of skin meshes to account for multiple instances
      ...
      if (isSkin) {
        primitives = skinIndices.map(skinIndex => {
          return this.parsePrimitives(gl, primitives, desc, bufferViews, materials, 1, isLightmap).map(({
            ...
            mesh.name = name; // TODO: support skin frustum culling
        ...
        primitives = this.parsePrimitives(gl, primitives, desc, bufferViews, materials, numInstances, isLightmap).map(({
          ...
          mesh.name = name; // Tag mesh so that nodes can add their transforms to the instance attribute
  ...
  static parseAccessor(index, desc, bufferViews) {
    ...
    const newData = isInterleaved ? new TypeArray(data) : new TypeArray(data, byteOffset, count * size); // Return attribute data
  ...
  static parseNodes(gl, desc, meshes, skins, images) {
    ...
    const nodes = desc.nodes.map(({
      ...
      let isSkin = skinIndex !== undefined; // add mesh if included
      ...
      if (meshIndex !== undefined) {
        if (isSkin) {
          ...
          meshes[meshIndex].primitives.instanceCount++; // Remove properties once all instances added
          ...
          meshes[meshIndex].primitives.forEach(mesh => {
            mesh.extras = extras; // instanced mesh might only have 1
...
var Stage = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Stage, [{
    ...
    value: function createRenderer() {
      ...
      this.gl.gl.clearColor(0.945, 0.945, 0.945, 0.1);
    ...
    value: function createGeo() {
      this.planeGeometry = new _ogl.Plane(this.gl, {
        heightSegments: 50,
        widthSegments: 100
      });
    }
...
},{"@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js","ogl":"../node_modules/ogl/src/index.mjs"}],"main.js":[function(require,module,exports) {
"use strict";
...
var app = function app() {
  var stage = new _Stage.default(); // let ui = new GUIView();
  // ui.init();
...
},{"./style/main.scss":"style/main.scss","./js/app":"js/app.js","./js/Stage":"js/Stage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
